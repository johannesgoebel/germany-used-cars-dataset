...
drawScatterplot pointLabels xValues yValues transmissionList xLabel yLabel =
    ...
    svg [ viewBox 0 0 w h, TypedSvg.Attributes.width <| TypedSvg.Types.Percent 100, TypedSvg.Attributes.height <| TypedSvg.Types.Percent 100 ]
        ...
        , g
            ...
            []
         -- labels    
        , g[] [text_ [ TypedSvg.Attributes.InPx.fontSize 10 , y 10, x 200] [ text ("Petrol")]
                , text_ [ TypedSvg.Attributes.InPx.fontSize 10 , y 25, x 200] [ text ("Diesel")]
                , text_ [ TypedSvg.Attributes.InPx.fontSize 10 , y 10, x 350] [ text ("Hybrid")]
                , text_ [ TypedSvg.Attributes.InPx.fontSize 10 , y 25, x 350] [ text ("Electric")]
                , text_ [ TypedSvg.Attributes.InPx.fontSize 10 , y 10, x 500] [ text ("lpg")]
                , text_ [ TypedSvg.Attributes.InPx.fontSize 10 , y 25, x 500] [ text ("cng")]
                , text_ [ TypedSvg.Attributes.InPx.fontSize 10 , y 10, x 100] [ text ("diesel_hybrid")]
                , text_ [ TypedSvg.Attributes.InPx.fontSize 10 , y 25, x 100] [ text ("other")]
                , text_ [ TypedSvg.Attributes.InPx.fontSize 10 , y 10, x 610] [ text ("unknwon")]
